...
CLIENT_PPS = [1]#[i for i in range(1000, 30000 + 1, 3000)]#[i for i in range(100000, 1_300_001, 100000)]
NUM_CONNECTIONS = [9]#[i for i in range(1, 10 + 1, 2)]
NUM_THREADS = [5, 6]#[i for i in range(1, 5 + 1, 1)]
RUNTIME = 10
TCPDUMP = False
