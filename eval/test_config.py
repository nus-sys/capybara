...
################## VARS #####################
### CLIENT ###
CLIENT_PPS = [500000, 550000, 600000, 650000, 700000]#[i for i in range(300000, 650000 + 1, 100000)]#[i for i in range(100000, 1_300_001, 100000)]
DATA_SIZE = [128, 1024]
NUM_CONNECTIONS = [1, 32, 64, 128]
RUNTIME = 5

### SERVER ###
# CAPY_LOG = 'all' # 'all', 'mig'
TIMER_RESOLUTION = [64, 1024 * 1024] # Default: 64
MAX_RECV_ITERS = [2, 1, 16] # 2
...
RECEIVE_BATCH_SIZE = [4, 32, 128] # 100
